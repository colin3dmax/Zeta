...
| 标准库 | ~55% | 字符串(escape 全/to_upper/lower/trim)/数组/整数工具 + **stdout print/println** + 基础文件 IO + 泛型数组 + **std.collections(HashMap/HashSet)** + **std.strings(split/join/replace/starts_with/ends_with)**;无网络 |
